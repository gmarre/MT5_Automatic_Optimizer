"""
Test INI Optimization

This script tests generating an .ini file for MT5 optimization.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("test_ini_optimization.log"),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger("TestINIOptimization")
...
def main():
    ...
    """
    # Parse arguments
    parser = argparse.ArgumentParser(description='Test generating an .ini file for MT5 optimization.')
    ...
    parser.add_argument('--output_file', type=str, default="optimization.ini",
